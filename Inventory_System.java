...
public class Inventory_System{ 
 ...
 private int def_capacity = 10; // sets default capacity to 10
  ...
  public Inventory_System(int capacity){ // constructor for InventorySystem (user defined capacity)
  ...
  public Inventory_System(){ // constructor for hashtable with predefined capacity 
